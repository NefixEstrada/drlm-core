...
func (s *TestJobSuite) TestList() {
	s.Run("should return a list with all the jobs if the agent id is 0", func() {
	...
	s.Run("should return an error if there's an error getting the list of jobs if the agent id is 0", func() {
